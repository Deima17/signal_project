 ...
 * 
 * <p>This implementation of {@link OutputStrategy} writes data to separate files
 * based on the data label. Each label gets its own file, allowing for organized
 * data persistence and easy post-processing.
 * 
 * <p>Files are created in a specified base directory, and data is appended
 * with timestamps for chronological tracking.
 */
public class FileOutputStrategy implements OutputStrategy {
     ...
     * Each data label will result in a separate file named "{label}.txt"
     ...
     * The base directory is created if it doesn't exist. Data is appended
     * to the file in a human-readable format.
     *
